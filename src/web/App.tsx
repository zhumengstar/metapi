...
export const sidebarGroups = [
  {
    ...
    items: [
      ...
      { to: '/playground', label: '模型测试', icon: <svg className="sidebar-item-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M12 6v12m-6-6h12" /></svg> },

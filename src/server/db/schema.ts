...
export const tokenModelAvailability = sqliteTable('token_model_availability', {
  ...
  routeEnabledSource: text('route_enabled_source').default('manual'),
  healthCheckSuccessStreak: integer('health_check_success_streak').default(0),
  routeManualDisabledAt: text('route_manual_disabled_at'),
  message: text('message'),
